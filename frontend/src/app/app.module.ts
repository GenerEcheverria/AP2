...
import { InformacionExpedientePacienteComponent } from './pages/expedientes/components/informacion-expediente-paciente/informacion-expediente-paciente.component';
...
@NgModule({
  declarations: [
    ...
    ListUsersComponent,
    InformacionExpedientePacienteComponent,
  ],
  imports: [
    BrowserModule,
    AppRoutingModule,
